...
public class VentanaMostrarAdoptante extends javax.swing.JFrame {

    public VentanaMostrarAdoptante() throws SQLException 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel8);
        jLabel8.setBounds(50, 190, 90, 18);

        jLabel9.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("Telefono:");
        jPanel2.add(jLabel9);
        jLabel9.setBounds(40, 230, 100, 18);

        jLabel10.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Direccion:");
        jPanel2.add(jLabel10);
        jLabel10.setBounds(50, 270, 90, 18);
        ...
        jButton1.setBounds(200, 320, 110, 22);
        ...
        jMenuItem3.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V, java.awt.event.InputEvent.ALT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        try 
        {
            VentanaPrincipalRefugio vpv = new VentanaPrincipalRefugio();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaMostrarAdoptante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try 
                {
                    new VentanaMostrarAdoptante().setVisible(true);
                } 
                catch (SQLException e) 
                {
                    JOptionPane.showMessageDialog(null,"Existe un error: "+e,"!! ERROR !!", 2);
