...
public class VentanaPrincipalRefugio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel9.add(jLabel1);
        jLabel1.setBounds(150, 0, 380, 40);
        ...
        jButton1.setText("  Agregar Adoptante");
        ...
        jButton2.setBounds(490, 170, 170, 30);
        ...
        jPanel9.add(jLabel7);
        jLabel7.setBounds(190, 320, 40, 50);
        ...
        jComboBox2.setBounds(240, 10, 110, 22);
        ...
        jTabbedPane3.addTab("Adoptante", jPanel10);
        ...
        jComboBox1.setBounds(240, 10, 110, 22);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        else if(jComboBox1.getSelectedItem().equals("Discapacidad"))
        {
            for (int i = a; i >= 0; i--) 
            {
                dtm2.removeRow(dtm2.getRowCount()-1);             
                ...
                this.setLLenarTablaMascotas("SELECT ID_mct, nombre_mct, ID_prs FROM mascotas WHERE estatus_mct = 'Discapacidad'");
        }
    ...
    String filas1 [][] = {};
    String columnas1 [] = {"Clave de adoptante", "Nombre"};
    
    String filas2 [][] = {};
    String columnas2 [] = {"Clave de mascotas", "Nombre", "Adoptante"};
}
