...
public class VentanaRegistroMascotas extends javax.swing.JFrame {
    ...
    public VentanaRegistroMascotas() throws SQLException
    {
        initComponents();

        cn = new Conexion();
        ldv = new LeerDatosRefugio();
        cl = new Consultas();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/user.png")));
        jPanel2.add(jLabel4);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/pawprint (1).png")));
        jPanel3.add(jLabel5);
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecciona", "Normal", "Discapacidad" }));
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/wiping-swipe-for-floors.png")));
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/exit.png")));
