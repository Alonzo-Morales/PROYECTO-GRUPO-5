...
public class VentanaRegistroAdoptante extends javax.swing.JFrame {

    public VentanaRegistroAdoptante() throws SQLException 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REGISTRO ADOPTANTE");
        jPanel1.add(jLabel1);
        ...
        jComboBox1.setBounds(290, 120, 100, 22);
        ...
        jLabel14.setBounds(440, 260, 70, 70);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaRegistroAdoptante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try 
                {
                    new VentanaRegistroAdoptante().setVisible(true);
                } 
                catch (SQLException e) 
                {
